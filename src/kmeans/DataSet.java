...
public class DataSet {
    ...
    public DataSet(String csvFileName) throws IOException {
        ...
        try(BufferedReader csvReader = new BufferedReader(new FileReader(csvFileName))) {
        	//Pega a primeira linha (cabeçalho, isto é, os nomes das colunas e atribui na linkedList attrNames.
            ...
            while ((row = csvReader.readLine()) != null) {
                ...
                //Verifica se a quantidade de colunas do cabeçalho (primeira linha) é a mesma das linhas 
                //que se seguem. Tem que ser iguais para "casar" linhas com colunas"
                if(attrNames.size() == data.length) {
                    for (int i = 0; i < attrNames.size(); i++) {
                    	//Pega o nome da coluna do cabeçalho (primeira linha)
                        String name = attrNames.get(i);
                        
                        //pega o valor coluna referente à coluna da linha anterior.
                        //Ex.: Documento: 
                        /*
                         * A, B
                         * 1, 3
                         * 5, 8
                         * 
                         * Pega o A e o 1 no primeiro laço, no segundo, B e 3.
                         * E assim até acabar de ler o arquivo, ou seja, pega o A e o 5
                         * depois o B e o 8...
                         */
